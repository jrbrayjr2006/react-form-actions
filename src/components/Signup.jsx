...
import { isNotEmpty, isEmail, hasMinLength, isEqualToOtherValue } from "../util/validation.js";
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.enteredValues?.aquisitionChannel?.includes("google")}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultChecked={formState.enteredValues?.aquisitionChannel?.includes("friend")}
          />
        ...
        <div className="control">
          <input 
            ...
            name="acquisition" 
            value="other"
            defaultChecked={formState.enteredValues?.aquisitionChannel?.includes("other")}
             />
